  ...
  (!(function ($) {
    ...
    (a.prototype = {
      createPage: function (a, b) {
        void 0 !== sb_instagram_js_options.ajax_url &&
          ...
          $("#sbi-builder-app").length &&
            ...
            0 ===
              $(".sbi_resized_image_data").attr("data-resized").indexOf('{"') &&
            ((window.sbiresizedImages = JSON.parse(
              $(".sbi_resized_image_data").attr("data-resized")
            )),
      ...
      createFeeds: function (a) {
        a.whenFeedsCreated(
          $(".sbi").each(function (e) {
            ...
            var a = $(this),
              d =
                void 0 !== a.attr("data-sbi-flags")
                  ? a.attr("data-sbi-flags").split(",")
                  : [],
              j =
                void 0 !== a.attr("data-options")
                  ? JSON.parse(a.attr("data-options"))
                  : {};
            ...
            var f,
              ...
              k = {
                ...
                colsmobile:
                  void 0 !== a.attr("data-colsmobile") &&
                  "same" !== a.attr("data-colsmobile")
                    ? a.attr("data-colsmobile")
                    : a.attr("data-cols"),
                colstablet:
                  void 0 !== a.attr("data-colstablet") &&
                  "same" !== a.attr("data-colstablet")
                    ? a.attr("data-colstablet")
                    : a.attr("data-cols"),
                num: a.attr("data-num"),
                imgRes: a.attr("data-res"),
                feedID: a.attr("data-feedid"),
                postID:
                  "undefind" != typeof a.attr("data-postid")
                    ? a.attr("data-postid")
                    : "unknown",
      ...
      encodeHTML: function (b) {
        ...
        var a = b.replace(/(>)/g, "&gt;"),
          a = a.replace(/(<)/g, "&lt;");
        return (a = a.replace(/(&lt;br\/&gt;)/g, "<br>")).replace(
          /(&lt;br&gt;)/g,
          "<br>"
        );
      },
      ...
      (b.prototype = {
        init: function () {
          ...
          (a.settings.consentGiven = a.checkConsent()),
            $(this.el).find(".sbi_photo").parent("p").length &&
              $(this.el).addClass("sbi_no_autop"),
            $(this.el).find("#sbi_mod_error").length &&
        ...
        afterLoadMoreClicked: function (a) {
          a.find(".sbi_loader").removeClass("sbi_hidden"),
            a.find(".sbi_btn_text").addClass("sbi_hidden"),
            a
              .closest(".sbi")
        ...
        afterNewImagesLoaded: function () {
          ...
          this.beforeNewImagesRevealed(),
            ...
            this.afterNewImagesRevealed(),
            setTimeout(function () {
              a.find(".sbi_loader").addClass("sbi_hidden"),
                a.find(".sbi_btn_text").removeClass("sbi_hidden"),
                b.maybeRaiseImageResolution();
            }, 500);
        },
        ...
        lazyLoadCheck: function (a) {
          if (
            a.find(".sbi_photo").length &&
            !a.closest(".sbi").hasClass("sbi-no-ll-check")
          ) {
            var b = this.getImageUrls(a),
              c =
                void 0 !== b[640]
                  ? b[640]
                  : a.find(".sbi_photo").attr("data-full-res");
            !(!this.settings.consentGiven && c.indexOf("scontent") > -1) &&
              a.find(".sbi_photo img").each(function () {
                c &&
                  void 0 !== $(this).attr("data-src") &&
                  $(this).attr("data-src", c),
                  c &&
                    void 0 !== $(this).attr("data-orig-src") &&
                    $(this).attr("data-orig-src", c),
                  $(this).on("load", function () {
                    !$(this).hasClass("sbi-replaced") &&
                      $(this).attr("src").indexOf("placeholder") > -1 &&
                      ($(this).addClass("sbi-replaced"),
                      c &&
                        ($(this).attr("src", c),
                        $(this).closest(".sbi_imgLiquid_bgSize").length &&
                          $(this)
        ...
        setResizedImages: function () {
          $(this.el).find(".sbi_resized_image_data").length &&
          void 0 !==
            $(this.el).find(".sbi_resized_image_data").attr("data-resized") &&
          0 ===
            $(this.el)
        ...
        sendNeedsResizingToServer: function () {
          ...
          if (a.needsResizing.length > 0 && a.settings.resizingEnabled) {
            var g = $(this.el).find(".sbi_item").length,
              h =
                void 0 !== a.settings.general.cache_all &&
                a.settings.general.cache_all,
              b = "";
            if (
              (void 0 !== d.attr("data-locatornonce") &&
                (b = d.attr("data-locatornonce")),
              $("#sbi-builder-app").length)
            ) {
              if (
            ...
            var e = {
              ...
              f = function (c) {
                var b = c;
                for (var d in ("object" != typeof c &&
                  0 === c.trim().indexOf("{") &&
                  (b = JSON.parse(c.trim())),
                a.settings.debugEnabled && console.log(b),
                b))
                  b.hasOwnProperty(d) && (a.resizedImages[d] = b[d]);
        ...
        getNewPostSet: function () {
          ...
          a.page++;
          var d = "";
          void 0 !== b.attr("data-locatornonce") &&
            (d = b.attr("data-locatornonce"));
          var e = {
          ...
          c(e, function (d) {
            ...
            "object" != typeof d &&
              ...
              a.settings.ajaxPostLoad
                ? ((a.settings.ajaxPostLoad = !1), a.afterInitialImagesLoaded())
                : a.afterNewImagesLoaded(),
              c.feedStatus.shouldPaginate
                ? (a.outOfPages = !1)
                : ((a.outOfPages = !0), b.find(".sbi_load_btn").hide()),
              $(".sbi_no_js").removeClass("sbi_no_js");
          });
        },
        appendNewPosts: function (b) {
          var a = $(this.el);
          a.find("#sbi_images .sbi_item").length
            ? a.find("#sbi_images .sbi_item").last().after(b)
            : a.find("#sbi_images").append(b);
        },
        ...
        setImageHeight: function () {
          var a = $(this.el),
            ...
            b =
              a.find("#sbi_images").innerWidth() -
              a.find("#sbi_images").width(),
            e = b / 2;
          (sbi_photo_width_manual = a.find("#sbi_images").width() / d - b),
            ...
            a.find(".sbi-owl-nav").length &&
              setTimeout(function () {
                ...
                (c += parseInt(e) * (2 + (2 - b))),
                  a.find(".sbi-owl-nav div").css("top", c);
              }, 100);
        },
        maybeRaiseSingleImageResolution: function (a, n, f) {
          var c = this,
            ...
            i = a.find("img").get(0),
            j =
              e === window.sbi.options.placeholder
                ? 1
                : i.naturalWidth / i.naturalHeight,
            f = void 0 !== f && f;
          if (
            !(
              a.hasClass("sbi_no_resraise") ||
              a.hasClass("sbi_had_error") ||
              (a.find(".sbi_link_area").length &&
                a.find(".sbi_link_area").hasClass("sbi_had_error"))
            )
          ) {
            if (d.length < 1) {
              a.find(".sbi_link_area").length &&
            ...
            ((a.find(".sbi_link_area").length &&
              a.find(".sbi_link_area").attr("href") ===
                window.sbi.options.placeholder.replace(
                  "placeholder.png",
                  "thumb-placeholder.png"
                )) ||
              !c.settings.consentGiven) &&
              a.find(".sbi_link_area").attr("href", d[d.length - 1]),
              void 0 !== d[640] &&
                a.find(".sbi_photo").attr("data-full-res", d[640]),
              $.each(d, function (a, b) {
            ...
            switch (c.settings.imgRes) {
              ...
              default:
                var k = Math.max(
                    c.settings.autoMinRes,
                    a.find(".sbi_photo").innerWidth()
                  ),
            ...
            if (b > h || e === window.sbi.options.placeholder || f) {
              ...
              if (
                (e !== g &&
                  (a.find(".sbi_photo img").attr("src", g),
                  a
                    .find(".sbi_photo")
                    .css("background-image", 'url("' + g + '")')),
                (h = b),
                "auto" === c.settings.imgRes)
              ) {
                var o = !1;
                a.find(".sbi_photo img").on("load", function () {
                  ...
                  if (1e3 !== f.get(0).naturalWidth && i > j && !o) {
                    switch (
                      (c.settings.debugEnabled &&
                        console.log(
                          "rais res again for aspect ratio change " + e
                        ),
                      (o = !0),
                      (k = a.find(".sbi_photo").innerWidth()),
                      (l = c.getBestResolutionForAuto(k, i, a)),
                      (b = 640),
                      l)
                    ) {
                      case 320:
            ...
            a.find("img").on("error", function () {
              if ($(this).hasClass("sbi_img_error"))
                ...
                if (
                  ...
                  !(
                    $(this).attr("src").indexOf("media/?size=") > -1 ||
                    $(this).attr("src").indexOf("cdninstagram") > -1 ||
                    $(this).attr("src").indexOf("fbcdn") > -1
                  ) && c.settings.consentGiven)
                ) {
                  if (
                    "undefined" !==
                    $(this).closest(".sbi_photo").attr("data-img-src-set")
                  ) {
                    var a = JSON.parse(
                      $(this)
                        .closest(".sbi_photo")
        ...
        maybeRaiseImageResolution: function (b) {
          ...
          $(a.el)
            ...
            .each(function (b) {
              !$(this).hasClass("sbi_num_diff_hide") &&
                $(this).find(".sbi_photo").length &&
                void 0 !==
                  $(this).find(".sbi_photo").attr("data-img-src-set") &&
                a.maybeRaiseSingleImageResolution($(this), b, c);
            }),
            (a.isInitialized = !0);
        },
        getBestResolutionForAuto: function (d, a, e) {
          ...
          var b = 10 * Math.ceil((d * a) / 10),
            c = [150, 320, 640];
          if (
            (e.hasClass("sbi_highlighted") && (b *= 2),
            -1 === c.indexOf(parseInt(b)))
          ) {
            var f = !1;
            $.each(c, function (c, a) {
        ...
        hideExtraImagesForWidth: function () {
          if ("carousel" !== this.layout) {
            var a = $(this.el),
              b =
                void 0 !== a.attr("data-num") && "" !== a.attr("data-num")
                  ? parseInt(a.attr("data-num"))
                  : 1,
              c =
                void 0 !== a.attr("data-nummobile") &&
                "" !== a.attr("data-nummobile")
                  ? parseInt(a.attr("data-nummobile"))
                  : b;
        ...
        setImageSizeClass: function () {
          ...
          var d = a.innerWidth(),
            e =
              parseInt(
                a.find("#sbi_images").outerWidth() -
                  a.find("#sbi_images").width()
              ) / 2,
            c = this.getColumnCount(),
            b = (d - e * (c + 2)) / c;
          b > 120 && b < 240
            ? a.addClass("sbi_medium")
            : b <= 120 && a.addClass("sbi_small");
        },
        setMinImageWidth: function () {
          $(this.el).find(".sbi_item .sbi_photo").first().length
            ? (this.minImageWidth = $(this.el)
        ...
        getImageUrls: function (d) {
          ...
          if (
            ...
            if (void 0 !== this.resizedImages[a].sizes) {
              var b = [];
              void 0 !== this.resizedImages[a].sizes.full &&
                ((c[640] =
                  sb_instagram_js_options.resized_url +
                  this.resizedImages[a].id +
                  "full.jpg"),
                b.push(640)),
                void 0 !== this.resizedImages[a].sizes.low &&
                  ((c[320] =
                    sb_instagram_js_options.resized_url +
                    this.resizedImages[a].id +
                    "low.jpg"),
                  b.push(320)),
                void 0 !== this.resizedImages[a].sizes.thumb &&
                  (b.push(150),
                  (c[150] =
                    sb_instagram_js_options.resized_url +
                    this.resizedImages[a].id +
            ...
            (void 0 === this.resizedImages[a] ||
              (void 0 !== this.resizedImages[a].id &&
                "pending" !== this.resizedImages[a].id &&
                "error" !== this.resizedImages[a].id)) &&
              this.addToNeedsResizing(a);
          return c;
        },
        ...
        applyImageLiquid: function () {
          ...
          ((b = b || { VER: "0.9.944" }).bgs_Available = !1),
                    ...
                    this.each(function (g) {
                      function h() {
                        function d() {
                          f.data("sbi_imgLiquid_error") ||
                            ...
                            f[0].width > 0 &&
                            f[0].height > 0
                              ? (f.data("sbi_imgLiquid_loaded", !0),
                                setTimeout(l, g * c.delay))
                              : setTimeout(d, c.timecheckvisibility));
                        }
                        if (
                          f.data("oldSrc") &&
                      ...
                      function k() {
                        (c.responsive ||
                          ...
                          (e.actualSize =
                            e.get(0).offsetWidth + e.get(0).offsetHeight / 1e4),
                          e.sizeOld && e.actualSize !== e.sizeOld && l(),
                          (e.sizeOld = e.actualSize),
                          setTimeout(k, c.responsiveCheckTime));
                      }
                      function i() {
                        f.data("sbi_imgLiquid_error", !0),
                          e.addClass("sbi_imgLiquid_error"),
                          c.onItemError && c.onItemError(g, e, f),
                          j();
                      }
                      function l() {
                        var i,
                          ...
                          p = e.width(),
                          q = e.height();
                        void 0 === f.data("owidth") &&
                          f.data("owidth", f[0].width),
                          void 0 === f.data("oheight") &&
                            f.data("oheight", f[0].height),
                          c.fill ===
                          p / q >= f.data("owidth") / f.data("oheight")
                            ? ((i = "100%"),
                              (k = "auto"),
                              (l = Math.floor(p)),
                              (m = Math.floor(
                                p * (f.data("oheight") / f.data("owidth"))
                              )))
                            : ((i = "auto"),
                              (k = "100%"),
                              (l = Math.floor(
                                q * (f.data("owidth") / f.data("oheight"))
                              )),
                              (m = Math.floor(q))),
                          ...
                          void (b.bgs_Available && c.useBackgroundSize
                            ? (-1 ===
                                e
                                  ...
                                  .indexOf(encodeURI(f.attr("src"))) &&
                                e.css({
                                  "background-image":
                                    'url("' + encodeURI(f.attr("src")) + '")',
                                }),
                              e.css({
            ...
            d.appendChild(a),
            "function" == typeof e.find(".sbi_photo").sbi_imgLiquid &&
              e.find(".sbi_photo").sbi_imgLiquid({ fill: !0 });
        },
        listenForVisibilityChange: function () {
          ...
          (a = jQuery),
            ...
            "function" ==
              typeof $(this.el).filter(":hidden").sbiVisibilityChanged &&
              $(this.el)
                .filter(":hidden")
            ...
            c.hasClass("sbi_mob_col_auto")
              ? (sbiWindowWidth < 640 &&
                ...
                sbiWindowWidth < 640 &&
                  ...
                  11 > parseInt(a) &&
                  (b = 4),
                sbiWindowWidth <= 480 && parseInt(a) > 2 && (b = 1))
        ...
        locationGuess: function () {
          var a = $(this.el),
            b = "content";
          return (
            a.closest("footer").length
              ? (b = "footer")
              : a.closest(".header").length || a.closest("header").length
              ? (b = "header")
              : (a.closest(".sidebar").length || a.closest("aside").length) &&
                (b = "sidebar"),
            b
          );
        },
  ...
  jQuery(document).ready(function ($) {
    void 0 === window.sb_instagram_js_options &&
      ...
      $(".cli-user-preference-checkbox").on("click", function () {
        setTimeout(function () {
          $.each(window.sbi.feeds, function (a) {
            (window.sbi.feeds[a].settings.consentGiven = !1),
              window.sbi.feeds[a].afterConsentToggled();
          });
        }, 1e3);
      }),
      $(window).on("CookiebotOnAccept", function (a) {
        $.each(window.sbi.feeds, function (a) {
          (window.sbi.feeds[a].settings.consentGiven = !0),
            window.sbi.feeds[a].afterConsentToggled();
        });
      }),

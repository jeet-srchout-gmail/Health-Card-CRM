  ...
  $win.on("load", function () {
    ...
    $(".booked-tabs")
      ...
      .each(function () {
        ...
        totalAppointments = $("#profile-" + thisTabName).find(
          ".appt-block"
        ).length;
    ...
    $(".booked-fea-appt-list").on("click", ".appt-block .delete", function (e) {
      ...
      if (confirm_appt_delete == true) {
        var currentApptCount = parseInt(
          $button.parents(".booked-fea-appt-list").find("h4 span.count").html()
        );
        currentApptCount = parseInt(currentApptCount - 1);
        $button
          .parents(".booked-fea-appt-list")

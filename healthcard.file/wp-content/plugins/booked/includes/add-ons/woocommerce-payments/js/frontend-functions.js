(function ($, window, document, undefined) {
  ...
  $doc.ready(function () {
    ...
    $(document).on(
      "booked-on-requested-appointment",
      function (event, redirectObj) {
        redirectObj.redirect =
          booked_wc_redirect_to_checkout_if_product_option();
      }
    );
  });
  ...
  function booked_wc_load_variations(
    ...
    $.post(booked_wc_variables.ajaxurl, data, function (response) {
  ...
  function booked_wc_btn_pay_appointment_shortcode() {
    $(".booked-profile-appt-list .appt-block .pay").on(
      "click",
      function (event) {
        event.preventDefault();

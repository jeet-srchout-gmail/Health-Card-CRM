          ...
          (t) => {
            if (t.target.classList.contains("jarallax-img")) {
              ...
              e &&
                e.jarallax &&
                e.jarallax.image &&
                e.jarallax.image.$item &&
                (e.jarallax.image.$item = t.target);
            }
          },
          { passive: !0 }
        );
  ...
  !(function () {
    ...
    function t(t, e, i) {
      ...
      function w() {
        ...
        g ||
          ...
          void 0 === c && d > t
            ? l
              ? ((u = Date.now()), r || (a = setTimeout(c ? p : w, t)))
              : w()
            : !0 !== r &&
              (a = setTimeout(c ? p : w, void 0 === c ? t - d : t)));
      }
      return (
        (w.cancel = function (t) {
    ...
    function a(t, e) {
      (arguments.length > 2 && void 0 !== arguments[2]
        ? arguments[2]
        : document
      ).addEventListener(`awb-${t}`, e);
    }
    const { AWB: n = {} } = window,
      o = /Android|iPhone|iPad|iPod|BlackBerry|Windows Phone/g.test(
    ...
    n.settings &&
      n.settings.disable_parallax &&
      n.settings.disable_parallax.length &&
      n.settings.disable_parallax.forEach((t) => {
        if (!u)
          switch (t) {
            case "everywhere":
              u = !0;
      ...
      n.settings &&
        n.settings.disable_video &&
        n.settings.disable_video.length &&
        n.settings.disable_video.forEach((t) => {
          if (!b)
            switch (t) {
              case "everywhere":
                b = !0;
      ...
      a("before-init", (t) => {
        !(function (t) {
          if (
            !t ||
            !t.parentNode ||
            !t.parentNode.classList.contains("nk-awb-after-vc_row")
          )
            return;
          ...
          (a = !(!a || !a.matches(".vc_row:not(.nk-awb)")) && a),
            a &&
              ("true" === a.getAttribute("data-vc-full-width") &&
                t.removeAttribute("data-awb-stretch"),
              a.classList.add("nk-awb"),
              a.append(t)),
            e.remove();
        })(t.target),
          (function (t) {
            if (
              !t ||
              !t.parentNode ||
              !t.parentNode.classList.contains("nk-awb-after-vc_column")
            )
              return;
            const e = t.parentNode;
            let i = e.previousElementSibling;
            ...
            i &&
              (a.matches("[data-vc-stretch-content=true]") &&
                t.removeAttribute("data-awb-stretch"),
              i.classList.add("nk-awb"),
              i.append(t)),
              e.remove();
          })(t.target);
      });
    ...
    a("before-init", (t) => {
      window.GHOSTKIT ||
        (function (t) {
          const e =
            t.parentNode && t.parentNode.getAttribute("data-ghostkit-styles");
          e &&
            (p ||
              ((p = document.createElement("style")),
              p.setAttribute("id", "ghostkit-awb-custom-css-inline-css"),
              document.head.appendChild(p)),
            (f += e),
            t.parentNode.removeAttribute("data-ghostkit-styles"),
            (p.textContent = f));
        })(t.target);
    });
    const { settings: m } = w(),
      ...
      t &&
        ...
        t.forEach((t) => {
          const e = t.closest(".vc_row"),
            ...
            w = { "margin-left": 0, "margin-right": 0 };
    ...
    a("before-init", (t) => {
      !(function (t) {
        ...
        e && t.parentNode.classList.contains("wpb_column")
          ? (k([t]), v.push(t))
          : e
          ? (x([t]), h.push(t))
          : m.full_width_fallback &&
            t.parentNode.classList.contains("alignfull") &&
            (A([t]), y.push(t));
      })(t.target);
    }),
    ...
    function M() {
      S.forEach((t) => {
        t.awbMouseData.is_in_viewport &&
          (t.awbMouseData.rect = t.parentNode.getBoundingClientRect());
      });
    }
    const j = t(200, M);
    setInterval(M, 3e3),
      window.addEventListener("resize", j, { passive: !0 }),
      window.addEventListener("orientationchange", j, { passive: !0 }),
      window.addEventListener("load", j, { passive: !0 }),
      document.addEventListener("scroll", j, { passive: !0 });
    const C = t(200, (t, e, i) => {
        !(function (t, e, i) {
          let a, n, o;
          S.forEach((r) => {
            (a = r.awbMouseData),
              a &&
                "object" == typeof a &&
                (a.is_in_viewport || (i && z)) &&
                (i
                  ? ((n = -a.size * t), (o = -a.size * e))
                  : ((n = (a.rect.width - (t - a.rect.left)) / a.rect.width),
                    (o = (a.rect.height - (e - a.rect.top)) / a.rect.height),
                    (n > 1 || n < 0 || o > 1 || o < 0) &&
                      ((n = 0.5), (o = 0.5)),
                    (n = a.size * (n - 0.5) * 2),
                    (o = a.size * (o - 0.5) * 2)),
                (r.style.transform = `translateX(${n}px) translateY(${o}px) translateZ(0)`),
                (i && z) ||
                  (r.style.transition = `transform ${
                    i ? 2 : a.speed
      ...
      N = new L(
        (t) => {
          t.forEach((t) => {
            t.target.awbMouseData &&
              ((t.target.awbMouseData.is_in_viewport = t.isIntersecting),
              t.isIntersecting && j());
          });
        },
        { rootMargin: "50px" }
    ...
    function F(t) {
      (t && t.length) ||
        (t = document.querySelectorAll(".nk-awb .nk-awb-inner img")),
        t &&
          t.length &&
          t.forEach((t) => {
            ...
            if (e && e.objectFit && "cover" === e.objectFit) {
              ...
              if (e) {
                let a = t.clientWidth;
                i / e > t.clientWidth / t.clientHeight &&
                  (a = parseInt((t.clientHeight * i) / e, 10)),
                  t.getAttribute("sizes") !== `${a}px` &&
                    (t.setAttribute("sizes", `${a}px`),
                    t.getAttribute("data-sizes") &&
                      t.setAttribute("data-sizes", `${a}px`),
                    t.getAttribute("data-lazy-sizes") &&
                      t.setAttribute("data-lazy-sizes", `${a}px`));
              }
            }
          });
    }
    a("init", (t) => {
      !(function (t) {
        if (
          t.classList.contains("nk-awb-mouse-parallax") ||
          !t.getAttribute("data-awb-mouse-parallax-size")
        )
          return;
        const e = t.querySelector(":scope > .nk-awb-inner"),
          i = parseFloat(t.getAttribute("data-awb-mouse-parallax-size")) || 30,
          a =
            parseFloat(t.getAttribute("data-awb-mouse-parallax-speed")) || 1e4;
        t.classList.add("nk-awb-mouse-parallax"),
          ...
          S.push(e),
          1 === S.length &&
            (_ && window.DeviceOrientationEvent
    ...
    const B =
      (500,
      t(500, F, { debounceMode: !1 !== (void 0 !== (W = {}.atBegin) && W) }));
    var W;
    a("before-init", (t) => {
      F(t.target.querySelectorAll(".nk-awb-inner img"));
    }),
      window.addEventListener("resize", B, { passive: !0 }),
      window.addEventListener("orientationchange", B, { passive: !0 }),
      window.addEventListener("load", B, { passive: !0 });
    ...
    a("init", (t) => {
      !(function (t) {
        if (void 0 === I) return;
        const i = t.querySelector(".jarallax-img"),
          a = t.getAttribute("data-awb-type"),
        ...
        let r = !1,
          ...
          p =
            "true" === t.getAttribute("data-awb-parallax-mobile") ||
            "1" === t.getAttribute("data-awb-parallax-mobile");
        if (
          (("yt_vm_video" !== a && "video" !== a) ||
            ((r = t.getAttribute("data-awb-video")),
            (s = parseFloat(t.getAttribute("data-awb-video-start-time")) || 0),
            (l = parseFloat(t.getAttribute("data-awb-video-end-time")) || 0),
            (d = parseFloat(t.getAttribute("data-awb-video-volume")) || 0),
            (c = "false" !== t.getAttribute("data-awb-video-loop")),
            (g = "true" === t.getAttribute("data-awb-video-always-play")),
            (u =
              "1" === t.getAttribute("data-awb-video-mobile") ||
              "true" === t.getAttribute("data-awb-video-mobile")),
            !r || b || w || ((b = "scroll"), (w = 1), (p = u))),
          !b && !r)
        ) {
          const e = t.getAttribute("data-awb-image-background-size") || "cover",
            a =
              t.getAttribute("data-awb-image-background-position") || "50% 50%";
          return void (
            i && ((i.style.objectFit = e), (i.style.objectPosition = a))
          );
        }
        const f = {
          type: b,
        ...
        "pattern" === n && ((f.imgSize = "auto"), (f.imgRepeat = "repeat")),
          r &&
            ...
            (f.videoVolume = d),
            (f.videoLoop = c),
            (f.videoPlayOnlyVisible = !g));
        const m = t.querySelector(":scope > .nk-awb-inner"),
          h = m.querySelector("picture .jarallax-img");
        h &&
          (h.classList.remove("jarallax-img"),
          h.closest("picture").classList.add("jarallax-img")),
        ...
        t.forEach((t) => {
          ...
          !e &&
            ...
            i.forEach((t) => {
              !e &&
                t.tagName &&
                (t.classList.contains("nk-awb") ||
                  t.classList.contains("nk-awb-after-vc_row") ||
                  t.classList.contains("nk-awb-after-vc_column") ||
                  (t.firstElementChild &&
                    t.querySelector(
                      ".nk-awb, .nk-awb-after-vc_row, .nk-awb-after-vc_column"
                    ))) &&
                (e = !0);
            });
        }),
